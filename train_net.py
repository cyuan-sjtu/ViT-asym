...
def main(args):
    cfg = setup(args)
    print("Command cfg:", cfg.INPUT.MASK_FORMAT)
    register_coco_instances("my_dataset_train", {}, "../data/Endoscapes2023/processed/annotations/instances_train2017.json", "../data/Endoscapes2023/processed/train2017")
    register_coco_instances("my_dataset_test", {}, "../data/Endoscapes2023/processed/annotations/instances_test2017.json", "../data/Endoscapes2023/processed/test2017")
    ...
    #              'Liver Ligament']
    # metadata_train = {}
    # sem_seg_root_train = "../data/CholecSeg8k/processed_scene/labels/train"
    # image_root_train = "../data/CholecSeg8k/processed_scene/images/train"
    ...
    # MetadataCatalog.get(semantic_name_train).set(sem_seg_root=sem_seg_root_train,image_root=image_root_train,evaluator_type="sem_seg",ignore_label=255,**metadata_train)
    # MetadataCatalog.get(semantic_name_train).stuff_classes = class_name_mapping

    # metadata_test = {}
    # sem_seg_root_test = "../data/CholecSeg8k/processed_scene/labels/test"
    # image_root_test = "../data/CholecSeg8k/processed_scene/images/test"
    ...
    # metadata_test = {}
    # # sem_seg_root_test = "../data/Endovision18/processed_scene/labels/test"
    # # image_root_test = "../data/Endovision18/processed_scene/images/test"
    # sem_seg_root_test = "../data/Endovision18/processed_scene/seq/Test_Data/labels/test/seq_4"
    # image_root_test = "../data/Endovision18/processed_scene/seq/Test_Data/images/test/seq_4"
    # semantic_name_test = "Chole_stuffonly_test"
    # DatasetCatalog.register(semantic_name_test, lambda: load_sem_seg(sem_seg_root_test, image_root_test, gt_ext="png", image_ext="png"))
    # MetadataCatalog.get(semantic_name_test).set(sem_seg_root=sem_seg_root_test,image_root=image_root_test,evaluator_type="sem_seg",ignore_label=255,**metadata_test)
    # MetadataCatalog.get(semantic_name_test).stuff_classes = class_name_mapping
